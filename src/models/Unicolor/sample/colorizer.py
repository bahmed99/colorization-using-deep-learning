...
from models.Unicolor.sample.ImageMatch.warp import ImageWarper
...
class Colorizer():
    ...
    def load_model(self, load_clip, load_warper):
        ...
        module = importlib.import_module('models.Unicolor.framework.hybrid_tran.models.colorization')
